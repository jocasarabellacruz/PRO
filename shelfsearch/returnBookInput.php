        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Return Success!</h4>
                </div>
                <div class="modal-body">
                    <p class="text-center" id="successMessage">Book returned successfully!</p>
                </div>
    ...
    <div id="failureModal" class="modal fade">
        <div class="modal-dialog modal-confirm">
            <div class="modal-content" style="border: 2px solid rgb(167, 35, 35);">
                ...
                <div class="modal-body">
                    <p class="text-center" id="errorMessage">Book cannot be returned.</p>
                </div>
                <div class="modal-footer">
